...
| T-047 | Real-time collaboration (WebRTC signaling) | OpenCode | lib/realtime/, components/collab/ | done | 2026-08-08 16:10 | 2026-08-08 16:25 | lib/realtime/presence.ts, lib/realtime/presence.test.ts, components/collab/PresenceBar.tsx, components/collab/LiveCursors.tsx, components/collab/CollabChat.tsx, app/api/collab/messages/route.ts | Live presence, cursor sync, in-room chat + annotations via Redis |
...
- **OpenCode-Subagent-1 to 11 (T-041 to T-051):** T-041 (upload dropzone), T-043 (QA checklist), T-044 (publish+gate), T-045 (public viewer), T-046 (analytics), T-050 (Stripe subscriptions) done by OpenCode. Remaining unclaimed: T-042 (finish), T-049. T-051 (E2E tests) already committed
