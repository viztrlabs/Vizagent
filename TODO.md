...
- **OpenCode-Subagent-1 to 11 (T-041 to T-051):** T-041 (upload dropzone), T-043 (QA checklist), T-044 (publish+gate), T-045 (public viewer) done by OpenCode. Remaining unclaimed: T-042 (finish), T-046, T-047, T-049, T-050. T-051 (E2E tests) already committed
