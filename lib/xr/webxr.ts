...
import { Scene, Vector3, Quaternion, WebXRFeatureName, WebXRHitTest, WebXRSessionManager } from "@babylonjs/core";
...
const statusCallbacks: Set<(status: XRSessionStatus) => void> = new Set();
