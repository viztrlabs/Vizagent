...
export const metadata: Metadata = {
  title: 'Users | Admin Console | VizTR',
};
    ...
    <div className="min-h-screen bg-bg">
      <div className="max-w-6xl mx-auto px-4 py-6 sm:py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="font-display text-3xl sm:text-4xl text-white">Users</h1>
            <p className="text-gray-400 mt-1 text-sm sm:text-base">Manage users and roles</p>
          </div>
          <Link
            href="/admin"
