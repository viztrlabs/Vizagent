        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2 bg-surface border border-gray-800 rounded-lg text-white focus:outline-none focus:border-cyan h-24 resize-none min-h-touch"
          ...
          <div className="flex flex-col-reverse sm:flex-row gap-4 pt-4">
            <button
              type="button"
              onClick={() => router.back()}
              className="flex-1 py-3 bg-surface border border-gray-800 text-white rounded-lg font-medium hover:bg-surface/80 transition-colors min-h-touch"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={submitting}
              className="flex-1 py-3 bg-cyan text-bg rounded-lg font-medium hover:bg-cyan/90 transition-colors disabled:opacity-50 min-h-touch"
            >
