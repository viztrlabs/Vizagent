export default function HomePage() {
  return (
    <div className="container mx-auto px-4 py-12 sm:py-20">
      <h1 className="font-display text-4xl sm:text-5xl md:text-6xl text-center mb-4 sm:mb-6">
        Architectural Visualization <span className="text-cyan">Reimagined</span>
      </h1>
      <p className="text-base sm:text-xl text-gray-400 text-center max-w-2xl mx-auto mb-8 sm:mb-10 px-2">
